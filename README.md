...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/interleave-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15059&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/interleave-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `interleave` can be installed with:

```
conda install interleave
```

It is possible to list all of the versions of `interleave` available on your platform with:
